...
**Last updated:** 2026-06-24 (update 23)
**Project status:** Step 4.5 complete — token-based chunker live; parsed documents can now be split into embedding-ready 400-token chunks with 50-token overlap and sentence-boundary respect
...
**Tip of `main`:** `0145a56` (see §11 Build Journal)
