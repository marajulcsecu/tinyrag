...
> - llama.cpp build flags in §3.3 use the laptop recipe.
> - All package versions are identical (the source code is the same).
>
> **Identical content otherwise.** See `docs/05_tech_stack_v1.md` for the canonical version. If the two diverge, the canonical version wins.
